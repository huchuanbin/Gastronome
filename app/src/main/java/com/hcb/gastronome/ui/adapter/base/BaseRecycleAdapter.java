...
public abstract class BaseRecycleAdapter<T> extends RecyclerView.Adapter<BaseRecycleHolder> {
    ...
    public abstract void onBindViewHolder(ViewHolder holder, T data, int typePosition, int position);
    ...
    @Override
    public void onBindViewHolder(BaseRecycleHolder holder, int typePosition) {
        this.position = typePosition;
        onBindViewHolder(holder.getViewHolder(),
                (getItems() != null && getItems().size() > 0) ? list.get(getPosition()) : null,
        ...
        if (onItemLongClickListener != null) {
            holder.itemView.setOnLongClickListener(v ->
                    onItemLongClickListener.onItemLongClick(null, v, holder.getLayoutPosition(), holder.getItemId()));
        }
    }
