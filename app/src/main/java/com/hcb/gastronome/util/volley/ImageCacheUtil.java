package com.hcb.gastronome.util.volley;
...
import com.hcb.gastronome.util.MD5Utils;
 ...
 */
public class ImageCacheUtil implements ImageLoader.ImageCache{  private String TAG=ImageCacheUtil.this.getClass().getSimpleName();
